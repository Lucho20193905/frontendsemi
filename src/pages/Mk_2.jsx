              ...
              <div class="card bg-dark text-white" style={{borderRadius: '1rem'}}>
                <div class="card-body p-5 text-center">
                  ...
                  <div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <h2 class="fw-bold mb-2 text-uppercase" style={{textAlign: 'left'}} >LOG IN.</h2>
                    <p class="text-white-50 mb-5" style={{textAlign: 'left'}}>Log in with your details below to view your order</p>
                    ...
                    <p class="small mb-5 pb-lg-2" style={{textAlign: 'left'}}><a class="text-white-50" href="https://web.whatsapp.com/">Forgot password?</a></p>
